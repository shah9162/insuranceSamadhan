...
public class Lead_Links_Verify {
...
//		implicit wait
		...
		String path ="C:/Users/asus/eclipse-workspace/admin/src/test/java/com/admin/testData/Book2.xlsx";
		int rownum=XLUtils.getRowCount(path,"Sheet1");
		System.out.println(rownum);
		for(int i=1; i<=rownum;i++) {
			String linkUrl=XLUtils.getCellData(path, "Sheet1",i,0);
			...
			try
	        {
	           ...
	           String https =String.valueOf(http);
	            if(http>=400)
	            {
	            	...
	            	XLUtils.setCellData(path,"Sheet1",i,1,https);
	            	XLUtils.setCellData(path,"Sheet1",i,2,httpURLConnect.getResponseMessage());
	            }    
